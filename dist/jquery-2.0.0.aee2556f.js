...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"QedY":[function(require,module,exports) {
var define;
...
(function (window, undefined) {
  ...
  (function (window, undefined) {
    ...
    setDocument = Sizzle.setDocument = function (node) {
      ...
      rbuggyMatches = rbuggyMatches.length && new RegExp(rbuggyMatches.join("|")); // Element contains another
    ...
    [0, 0].sort(sortOrder);
    support.detectDuplicates = hasDuplicate; // Support: IE<8
  ...
  jQuery.support = function (support) {
    var input = document.createElement("input"),
        ...
        opt = select.appendChild(document.createElement("option")); // Finish early in limited environments

    if (!input.type) {
      return support;
    }

    input.type = "checkbox"; // Support: Safari 5.1, iOS 5.1, Android 4.x, Android 2.3
    ...
    fragment.appendChild(input); // Support: Safari 5.1, Android 4.x, Android 2.3
    ...
    jQuery(function () {
      ...
      div.innerHTML = ""; // Support: Firefox, Android 2.3 (Prefixed box-sizing versions).
  ...
  */
    ...
    set: function set(owner, data, value) {
      ...
      if (typeof data === "string") {
        ...
        if (jQuery.isEmptyObject(cache)) {
          this.cache[unlock] = data; // Otherwise, copy the properties one-by-one to the cache object
        } else {
          for (prop in data) {
  ...
  jQuery.extend({
    clone: function clone(elem, dataAndEvents, deepDataAndEvents) {
      var i,
          ...
          inPage = jQuery.contains(elem.ownerDocument, elem); // Support: IE >= 9
      // Fix Cloning issues
  ...
  jQuery.ajaxTransport(function (options) {
    var _callback2; // Cross domain only allowed if supported through XMLHttpRequest
    ...
    if (jQuery.support.cors || xhrSupported && !options.crossDomain) {
      return {
        send: function send(headers, complete) {
            ...
            return function () {
              if (_callback2) {
                ...
                if (type === "abort") {
                  ...
                  complete( // file protocol always yields status 0, assume 404
          ...
          xhr.onerror = _callback2("error"); // Create the abort callback
...
//# sourceMappingURL=jquery-2.0.0.aee2556f.js.map